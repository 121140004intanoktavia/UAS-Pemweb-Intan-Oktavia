    ...
    <div class="container-fluid text-center">
        <form action="" method="post" action="update.php">
            ...
            <table border="1">
                <tr>
                    <td colspan="2">
                        <h1 class="text-primary text-center"><b>Update Data</b></h1>
                    </td>
                </tr>
                <tr>
                    <td width="179"><b>Nama Album</b></td>
                    <td><label>
                            <input type="text" name="namaalbum" value="<?php echo $namaalbum; ?>" />
                        </label></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><label>
                            <input type="number" name="tahunrilis" value="<?php echo $tahunrilis; ?>" />
                        </label></td>
                </tr>
                ...
                <tr align="center">
                    <td colspan="2"><label>
                            <input type="submit" class="btn btn-primary mt-2" name="submit" value="Update Data">
                        </label></td>
                </tr>
            </table>
        </form>
